...
const LocPermition = ({back}) => {
  return (
    <div style={{backgroundImage: `url(${back})`}} className="w-screen h-screen bg-cover bg-no-repeat flex flex-col items-center">
      <div className="box w-[80%] h-[70%]  mt-14 flex flex-col items-center relative xl:w-[50%] xl:h-[80%] xl:mt-8">
        ...
        <img src="https://res.cloudinary.com/doswveiik/image/upload/v1722758266/WeatherIcons_vznnrm.gif" className="size-72 absolute top-0 lg:size-96 xl:size-80" alt="" />
